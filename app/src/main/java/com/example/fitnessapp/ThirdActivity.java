...
private long lefttime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (intvalue){
            ...
            break;
            case 2:
                setContentView(R.layout.activity_basiccrunches_pose);
                break;
            case 3:
                setContentView(R.layout.activity_bench_pose);
                break;
            case 4:
                setContentView(R.layout.activity_bicycle_pose);
                break;
            case 5:
                setContentView(R.layout.activity_legraise_pose);
                break;
            case 6:
