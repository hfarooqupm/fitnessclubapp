...
// bucle para que vayan pasando cada sesenta segundos de una actividad a la siguiente
        switch (intvalue){

            case 1:
                setContentView(R.layout.activity_boat_pose3);
                break;
            case 2:
                setContentView(R.layout.activity_basiccrunches_pose3);
                break;
            case 3:
                setContentView(R.layout.activity_bench_pose3);
                break;
            case 4:
                setContentView(R.layout.activity_bicycle_pose3);
                break;
            case 5:
                setContentView(R.layout.activity_legraise_pose3);
                break;
            case 6:
                setContentView(R.layout.activity_boatpose3);
                break;
            case 7:
                setContentView(R.layout.activity_legup_pose3);
                break;
            case 8:
                setContentView(R.layout.activity_situp_pose3);
                break;
            case 9:
                setContentView(R.layout.activity_vups_pose3);
                break;
            case 10:
                setContentView(R.layout.activity_plankrotation_pose3);
                break;
            case 11:
                setContentView(R.layout.activity_plankwithleft_pose3);
                break;
            case 12:
